...
app.config['MONGO_URI'] = 'mongodb+srv://admin:admin@cluster0-krvd8.mongodb.net/foodb?retryWrites=true&w=majority'

app.config['SECRET_KEY'] = 'yhjglo46L6SAfy4MDtAxpdz1bKtO37H728'
